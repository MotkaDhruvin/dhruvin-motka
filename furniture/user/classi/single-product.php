  ...
  <!-- <nav class="navbar navbar-expand-lg text-uppercase fs-6 p-3 border-bottom fixed-top bg-white">
    <div class="container-fluid">
      <div class="row justify-content-between align-items-center w-100">
        ...
        <div class="col-auto">
          <a class="navbar-brand" href="index.html"><img src="images/logo-dark.svg" width="100" height="45" alt="logo"></a>
        </div>
        ...
        <div class="col-auto">
          ...
          <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu list-unstyled border p-3" aria-labelledby="dropdownHome">
                <li>
                  <a href="index.html" class="dropdown-item item-anchor">Home Layout 1</a>
                </li>
                <li>
                  <a href="home2.html" class="dropdown-item item-anchor">Home Layout 2 <span class="badge bg-light text-dark ms-2">PRO</span></a>
                </li>
              </ul>
            </li>
            <li class="nav-item dropdown">
            ...
            <li class="nav-item">
              <a href="https://templatesjungle.gumroad.com/l/classi-html-template-for-furniture-shop" target="_blank" class="btn btn-outline-dark rounded-pill" href="#">Get PRO</a>
            </li>
          </ul>
            </div>
          </div>
                ...
                <div class="swiper product-thumbnail-slider vertical" data-num="6" data-direction="vertical">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <img src="images/product-thumbnail-1.jpg" alt="thumb-image" class="thumb-image img-fluid">
                    </div>
                    <div class="swiper-slide">
                      <img src="images/product-thumbnail-2.jpg" alt="thumb-image" class="thumb-image img-fluid">
                    </div>
                    <div class="swiper-slide">
                      <img src="images/product-thumbnail-3.jpg" alt="thumb-image" class="thumb-image img-fluid">
                    </div>
                    <div class="swiper-slide">
                      <img src="images/product-thumbnail-4.jpg" alt="thumb-image" class="thumb-image img-fluid">
                    </div>
                    <div class="swiper-slide">
                      <img src="images/product-thumbnail-5.jpg" alt="thumb-image" class="thumb-image img-fluid">
                    </div>
                  </div>
                </div>
                <!-- / product-thumbnail-slider -->
          ...
          <div class="col-md-5">
            <div class="product-info">
              <div class="element-header">
                <h2 itemprop="name" class="display-4 fw-bold">Handmade Wooden Sofa</h2>
              ...
              <div class="product-action mt-4">
                ...
                <div class="product-quantity d-flex flex-wrap gap-3">
                  ...
                  <button type="submit" name="add" id="add-to-cart"
                    class="btn btn-dark product-cart-submit text-uppercase">
