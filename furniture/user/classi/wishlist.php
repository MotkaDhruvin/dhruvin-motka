      ...
      <div class="product-wrapper">
        <div class="product-item row align-items-center mb-3 border-bottom">
          <div class="col-4 col-md-1 d-flex align-items-center text-left">
            <a href="#">
              <img srcset="images/product-thumb-1.jpg" alt="wishlist" class="img-fluid">
            </a>
          </div>
        ...
        <div class="product-item row align-items-center mb-3 border-bottom">
          <div class="col-4 col-md-1 d-flex align-items-center text-left">
            <a href="#">
              <img srcset="images/product-thumb-2.jpg" alt="wishlist" class="img-fluid">
            </a>
          </div>
          <div class="col-8 col-md-4">
            <h3 class="item-title">
        ...
        <div class="product-item row align-items-center mb-3 border-bottom">
          <div class="col-4 col-md-1 d-flex align-items-center text-left">
            <a href="#">
              <img srcset="images/product-thumb-3.jpg" alt="wishlist" class="img-fluid">
            </a>
          </div>
          <div class="col-8 col-md-4">
            <h3 class="item-title">
