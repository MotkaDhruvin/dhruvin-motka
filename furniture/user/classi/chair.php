...
<body class="homepage">
  ...
  <!-- <nav class="navbar navbar-expand-lg text-uppercase fs-6 p-3 border-bottom fixed-top bg-white">
    <div class="container-fluid">
      <a class="navbar-brand" href="shop.php"><img src="images/logo-dark.svg" width="100" height="45" alt="logo"></a>
          ...
          <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3 ">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu list-unstyled border p-3" aria-labelledby="dropdownPages">
                <li>
                  <a href="shop.php" class="dropdown-item item-anchor">Shop <span
                      class="badge bg-light text-dark ms-2">PRO</span></a>
                </li>
                <li>
                  <a href="chair.php" class="dropdown-item item-anchor">Single Product <span
                      class="badge bg-light text-dark ms-2">PRO</span></a>
                </li>
                <li>
                ...
                <li>
                  <a href="single-post-sidebar.html" class="dropdown-item item-anchor">Single Post w/sidebar <span
                      class="badge bg-light text-dark ms-2">PRO</span></a>
                </li>
                <li>
                ...
                <li>
                  <a href="#" class="dropdown-item item-anchor">Wishlist <span
                      class="badge bg-light text-dark ms-2">PRO</span></a>
                </li>
                <li>
  ...
  <section class="mt-5 pt-5 border-bottom">
    <div class="container-fluid">
      <div class="d-flex justify-content-between align-items-center">
        <h1 class="text-uppercase fs-3">chair</h1>
        <nav class="breadcrumb">
          <a class="breadcrumb-item" href="home2.php">Home</a>
        ...
        <div class="row row-cols-2 row-cols-md-3 row-cols-lg-5">
          <div class="col">
            <div class="product-item hover-effect-slide">
              <div class="image-holder position-relative">
                <a href="chair.php">
                  <img src="images/product-portrait-thumbnail-1.jpg" alt="categories" class="product-image img-fluid">
                </a>
                ...
                <a href="#" class="btn btn-dark w-100 mt-2 rounded-3">Add to cart</a>
              </div>
              <div class="product-content">
                <h5 class="mt-3">
                  <a href="chair.php">Dark florish onepiece</a>
                </h5>
                <span>$95.00</span>
              </div>
            </div>
          ...
          <div class="col">
            <div class="product-item hover-effect-slide">
              <div class="image-holder position-relative">
                <a href="chair.php">
                  <img src="images/product-portrait-thumbnail-2.jpg" alt="categories" class="product-image img-fluid">
                </a>
                <a href="#" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
              ...
              <div class="product-content">
                <h5 class="mt-3">
                  <a href="chair.php">Baggy Shirt</a>
                </h5>
                <span class="text-secondary">$55.00</span>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="product-item hover-effect-slide">
              <div class="image-holder position-relative">
                <a href="chair.php">
                  <img src="images/product-portrait-thumbnail-3.jpg" alt="categories" class="product-image img-fluid">
                </a>
                <a href="#" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
          ...
          <div class="col">
            <div class="product-item hover-effect-slide">
              <div class="image-holder position-relative">
                <a href="chair.php">
                  <img src="images/product-portrait-thumbnail-4.jpg" alt="categories" class="product-image img-fluid">
                </a>
                <a href="#" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
          ...
          <div class="col">
            <div class="product-item hover-effect-slide">
              <div class="image-holder position-relative">
                <a href="chair.php">
                  <img src="images/product-portrait-thumbnail-5.jpg" alt="categories" class="product-image img-fluid">
                </a>
                <a href="#" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
              ...
              <div class="product-content">
                <h5 class="mt-3">
                  <a href="chair.php">Cotton off-white shirt</a>
                </h5>
                <span class="text-secondary">$65.00</span>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="product-item hover-effect-slide">
              <div class="image-holder position-relative">
                <a href="chair.php">
                  <img src="images/product-portrait-thumbnail-6.jpg" alt="categories" class="product-image img-fluid">
                </a>
                <a href="#" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
              ...
              <div class="product-content">
                ...
                <span class="text-secondary">$95.00</span>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="product-item hover-effect-slide">
              <div class="image-holder position-relative">
                <a href="chair.php">
                  <img src="images/product-portrait-thumbnail-7.jpg" alt="categories" class="product-image img-fluid">
                </a>
                <a href="#" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
          ...
          <div class="col">
            <div class="product-item hover-effect-slide">
              <div class="image-holder position-relative">
                <a href="chair.php">
                  <img src="images/product-portrait-thumbnail-8.jpg" alt="categories" class="product-image img-fluid">
                </a>
                <a href="#" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
          ...
          <div class="col">
            <div class="product-item hover-effect-slide">
              <div class="image-holder position-relative">
                <a href="chair.php">
                  <img src="images/product-portrait-thumbnail-9.jpg" alt="categories" class="product-image img-fluid">
                </a>
                <a href="#" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
          ...
          <div class="col">
            <div class="product-item hover-effect-slide">
              <div class="image-holder position-relative">
                <a href="chair.php">
                  <img src="images/product-portrait-thumbnail-10.jpg" alt="categories" class="product-image img-fluid">
                </a>
                <a href="#" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
