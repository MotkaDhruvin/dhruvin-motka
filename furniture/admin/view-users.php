                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                ...
                                <div>
                                  <h6 class="mb-0 text-truncate"><?php echo $user->u_fname; ?></h6>
                                  <small class="text-truncate"><?php echo $user->u_lname; ?></small>
                                </div>
                              </div>
                            </td>
                            <td class="text-truncate"><?php echo $user->u_email; ?></td>
                            <td class="text-truncate">
                              <i class="mdi mdi-laptop mdi-24px text-danger me-1"></i> Admin
                            </td>
                            <td class="text-truncate"><?php echo $user->u_phone; ?></td>
                            <td class="text-truncate"><?php echo $user->u_password; ?></td>
